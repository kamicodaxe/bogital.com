...
const School: NextPage<Props> = ({ data }) => {
  ...
  return (
    <Layout locale={locale as string} title={s.title} desc={s.desc}>
      <Header locale={locale as string} title="School" className="bg-[url(https://source.unsplash.com/xhGMQ_nYWqU/1280x)]" active='contact' />
...
const strings = {
  'en': {
    'title': 'School, Bogital By Bogital',
    'desc': 'School, Bogital By Bogital',
    'subtitle': '',
    'contact': 'School us',
    'form': 'School form',
    'name': 'Full name',
